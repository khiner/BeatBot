...
{
    __android_log_print(ANDROID_LOG_INFO, "about to add samples in pTDStretch", "pitch");                
    // Add the samples into the input buffer    
    inputBuffer.putSamples(samples, nSamples);
    __android_log_print(ANDROID_LOG_INFO, "about to process samples in pTDStretch", "pitch");                
