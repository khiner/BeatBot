...
public class IconResourceSets {
	public static IconResourceSet
			DEFAULT = s(r(Colors.VIEW_BG, Colors.TRON_BLUE), r(Colors.VIEW_BG_SELECTED, Colors.TRON_BLUE)),
			SAMPLE_LOOP = s(r(Colors.TRON_BLUE_TRANS), r(Colors.TRON_BLUE)),
			...
			COPY = s(r(R.drawable.copy_icon, null, Colors.WHITE), r(R.drawable.copy_icon, null, Colors.TRON_BLUE), r(R.drawable.copy_icon, null, Colors.TRON_BLUE), r(R.drawable.copy_icon, null, Colors.SEMI_TRANSPARENT)),
			QUANTIZE = s(r(R.drawable.quantize_icon, null, Colors.WHITE), r(R.drawable.quantize_icon, null, Colors.TRON_BLUE), null, r(R.drawable.quantize_icon, null, Colors.SEMI_TRANSPARENT)),
			...
			INSTRUMENT_BASE = s(r(Colors.TRANSPARENT, Colors.WHITE), r(Colors.LABEL_SELECTED, Colors.BLACK), r(Colors.TRON_BLUE, Colors.BLACK)),
			...
			LABEL_BASE = s(r(Colors.LABEL_DARK, Colors.WHITE), r(Colors.TRON_BLUE, Colors.BLACK), r(Colors.LABEL_SELECTED, Colors.BLACK)),
			...
			MENU_ITEM = s(r(null), r(Colors.LABEL_LIGHT), r(Colors.TRON_BLUE)),
			
			FILE = s(r(R.drawable.browse_icon, null, Colors.BLACK), r(R.drawable.browse_icon, null, Colors.TRON_BLUE)),
			SETTINGS = s(r(R.drawable.settings_icon, null, Colors.BLACK), r(R.drawable.settings_icon, null, Colors.TRON_BLUE)),
			...
			ATTACK = s(r(R.drawable.attack_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.attack_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.attack_icon, Colors.TRON_BLUE, Colors.BLACK)),
			DECAY = s(r(R.drawable.decay_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.decay_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.decay_icon, Colors.TRON_BLUE, Colors.BLACK)),
			SUSTAIN = s(r(R.drawable.sustain_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.sustain_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.sustain_icon, Colors.TRON_BLUE, Colors.BLACK)),
			RELEASE = s(r(R.drawable.release_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.release_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.release_icon, Colors.TRON_BLUE, Colors.BLACK)),
			
			VOLUME = s(r(Colors.TRANSPARENT, Colors.TRON_BLUE), r(Colors.TRON_BLUE, Colors.BLACK), r(Colors.TRON_BLUE, Colors.BLACK), r(Colors.TRANSPARENT, Colors.TRON_BLUE)),
			...
			LOOP = s(r(R.drawable.loop_icon, null, Colors.WHITE), r(R.drawable.loop_icon, null, Colors.TRON_BLUE)),
			PREVIEW = s(r(R.drawable.preview_icon, null, Colors.WHITE), r(R.drawable.preview_icon_selected, null, Colors.WHITE)),
			REVERSE = s(r(R.drawable.reverse_icon, null, Colors.WHITE), r(R.drawable.reverse_icon, null, Colors.TRON_BLUE)),

			LINK = s(r(R.drawable.link_icon, null, Colors.WHITE), r(R.drawable.link_icon, null, Colors.TRON_BLUE)),

			TOGGLE = s(r(R.drawable.toggle_icon, Colors.LABEL_DARK, Colors.LABEL_LIGHT), r(R.drawable.toggle_icon, Colors.TRON_BLUE, Colors.TRON_BLUE), r(R.drawable.toggle_icon, Colors.LABEL_SELECTED, Colors.TRON_BLUE)),

			BANDPASS_FILTER = s(r(R.drawable.bandpass_filter_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.bandpass_filter_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.bandpass_filter_icon, Colors.TRON_BLUE, Colors.BLACK)),
			HIGHPASS_FILTER = s(r(R.drawable.highpass_filter_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.highpass_filter_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.highpass_filter_icon, Colors.TRON_BLUE, Colors.BLACK)),
			LOWPASS_FILTER = s(r(R.drawable.lowpass_filter_icon, Colors.TRANSPARENT, Colors.WHITE), r(R.drawable.lowpass_filter_icon, Colors.LABEL_SELECTED, Colors.BLACK), r(R.drawable.lowpass_filter_icon, Colors.TRON_BLUE, Colors.BLACK));
