...
public class IconResources {
	public static IconResource BANDPASS_FILTER, HIGHPASS_FILTER,
			...
			ATTACK, DECAY, SUSTAIN, RELEASE, BEAT_SYNC, LINK, ON_OFF, PLAY,
			STOP, RECORD, ADD, COPY, DELETE_NOTE, DELETE_TRACK, UNDO, REDO,
			EDIT, QUANTIZE, LEVELS, PREVIEW, LOOP, REVERSE, BROWSE, DRUMS,
			KICK, SNARE, HH_CLOSED, HH_OPEN, RIMSHOT, SAMPLE, MICROPHONE, BEAT,
			FILE, MENU, SETTINGS, SNAP_TO_GRID, MIDI_IMPORT, MIDI_EXPORT;
	...
	public static void init() {
		...
		ATTACK = new IconResource(R.drawable.attack_icon,
				R.drawable.attack_icon_selected,
				R.drawable.attack_icon_selected);
		DECAY = new IconResource(R.drawable.decay_icon,
				R.drawable.decay_icon_selected, R.drawable.decay_icon_selected);
		SUSTAIN = new IconResource(R.drawable.sustain_icon,
				R.drawable.sustain_icon_selected,
				R.drawable.sustain_icon_selected);
		RELEASE = new IconResource(R.drawable.release_icon,
		...
		LEVELS = new IconResource(R.drawable.levels_icon, -1,
				R.drawable.levels_icon_selected);
		...
		DRUMS = new IconResource(R.drawable.drums_icon,
				R.drawable.drums_icon_selected, R.drawable.drums_icon_selected);
		KICK = new IconResource(R.drawable.kick_icon,
				R.drawable.kick_icon_selected, R.drawable.kick_icon_selected);
		SNARE = new IconResource(R.drawable.snare_icon,
				R.drawable.snare_icon_selected, R.drawable.snare_icon_selected);
		HH_CLOSED = new IconResource(R.drawable.hh_closed_icon,
				R.drawable.hh_closed_icon_selected,
				R.drawable.hh_closed_icon_selected);
		HH_OPEN = new IconResource(R.drawable.hh_open_icon,
				R.drawable.hh_open_icon_selected,
				R.drawable.hh_open_icon_selected);
		RIMSHOT = new IconResource(R.drawable.rimshot_icon,
				R.drawable.rimshot_icon_selected,
				R.drawable.rimshot_icon_selected);

		MICROPHONE = new IconResource(R.drawable.microphone_icon,
				R.drawable.microphone_icon_selected,
				R.drawable.microphone_icon_selected);
		BEAT = new IconResource(R.drawable.beat_icon,
				R.drawable.beat_icon_selected, R.drawable.beat_icon_selected);
		SAMPLE = new IconResource(R.drawable.sample_icon,
