...
public class SpriteBatch {
	...
	// --Constants--//
	final static int VERTEX_SIZE = 4; // Vertex Size (in Components) ie.
										// (X,Y,U,V)
	...
	public SpriteBatch(GL10 gl, int maxSprites) {
		...
		this.vertices = new Vertices(gl, maxSprites * VERTICES_PER_SPRITE,
				maxSprites * INDICES_PER_SPRITE, false, true, false); // Create
																		// Rendering
																		// Vertices
	...
	// NOTE: the overloaded (non-texture) version assumes that the texture is
	// already bound!
	...
	public void endBatch() {
		if (numSprites > 0) { // IF Any Sprites to Render
			...
			vertices.draw(GL10.GL_TRIANGLES, 0, numSprites * INDICES_PER_SPRITE); // Render
																					// Batched
																					// Sprites
