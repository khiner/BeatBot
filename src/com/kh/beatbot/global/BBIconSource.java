...
public class BBIconSource {
	...
	public BBIconSource(int defaultIconResourceId, int selectedIconResourceId) {
		this(new BBIcon(defaultIconResourceId), new BBIcon(selectedIconResourceId), null);
	}
	
	public BBIconSource(int defaultIconResourceId, int selectedIconResourceId, int listViewIconResourceId) {
		this(new BBIcon(defaultIconResourceId), new BBIcon(selectedIconResourceId), new BBIcon(listViewIconResourceId));
	}
	
	public BBIconSource(BBIcon defaultIcon, BBIcon selectedIcon, BBIcon listViewIcon) {
