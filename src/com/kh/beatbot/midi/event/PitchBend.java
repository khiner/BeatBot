...
public class PitchBend extends ChannelEvent {
	...
	public PitchBend(long tick, int channel, int lsb, int msb, int pan, int pitch) {
		super(tick, ChannelEvent.PITCH_BEND, channel, lsb, msb, pan, pitch);
	}
	
	public PitchBend(long tick, long delta, int channel, int lsb, int msb, int pan, int pitch) {
		super(tick, delta, ChannelEvent.PITCH_BEND, channel, lsb, msb, pan, pitch);
	}
