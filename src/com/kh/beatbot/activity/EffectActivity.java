...
public class EffectActivity extends Activity {
	...
	GLSurfaceViewGroup effectSurface;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		effectSurface = (GLSurfaceViewGroup)findViewById(R.id.empty_group);
		EffectLayout renderer = new EffectLayout(effectSurface, effect);
		effectSurface.setBBRenderer(renderer);
		//if (setOn)
//			effect.setOn(true);
	}
